...
INSERT INTO PUBLISHERS (  N_NAME, PHONE   )
...
INSERT INTO BOOKS (ISBN, TITLE,AUTHOR_FIRST_NAME, AUTHOR_LAST_NAME,GENRE,  PRICE, DESCRIPTION, PUBLISHER )
values('161729120X', 'Spring In Action'  , 'Craig','Walls', 'Java',  29.99,
       'Spring in Action, Fourth Edition is a hands-on guide to the Spring Framework, ', 'Manning');

INSERT INTO BOOKS (ISBN, TITLE,  AUTHOR_FIRST_NAME, AUTHOR_LAST_NAME, GENRE,  PRICE, DESCRIPTION, PUBLISHER )
values('193239415X', 'Hibernate In Action'  , 'Christian','Bauer', 'Java',  9.99,
       'Hibernate in Action  explains all the concepts you need', 'Manning');

INSERT INTO BOOKS (ISBN,  TITLE,   AUTHOR_FIRST_NAME, AUTHOR_LAST_NAME,   GENRE,  PRICE, DESCRIPTION, PUBLISHER )
values('1931520720', 'Stories of Your Life and Others'  , 'Ted ',' Chiang', 'Science Fiction',  12.25,
       ' includes his first eight published stories plus the author''s story notes ', 'Manning');
